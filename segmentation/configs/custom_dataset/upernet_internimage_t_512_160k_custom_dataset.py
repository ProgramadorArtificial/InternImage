...
# --------------------------------------------------------
_base_ = [
    '../_base_/models/upernet_r50.py', '../_base_/datasets/custom_dataset.py',
...
model = dict(
    ...
    decode_head=dict(num_classes=3, in_channels=[64, 128, 256, 512]),
    auxiliary_head=dict(num_classes=3, in_channels=256),
